  ...
  return (
    <div className="mt-30">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 ">
            All you need to manage your Finances
          </h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {howItWorksData.map((step, index) => (
              <div
                key={index}
                className="items-center text-center p-6  flex flex-col gap-6"
              >
                <div className="w-16 h-16 bg-green-100 rounded-full mx-auto flex justify-center items-center">
                  {step.icon}
                </div>
                <h3 className="text-green-600 font-bold text-2xl">
                  {step.title}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 ">
            What our users say about Richloom?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <section className="py-20 bg-green-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Join thousands of users who trust Richloom to manage their finances.
          </p>
          <Link href="/dashboard">
